...
export const RULES = { style: 'title',
  stops: {
    'Sherway Gardens Rd at Sherway Gate Mall)': 'Sherway Gardens Rd at Sherway Gate Mall',
    'McCowan Rd at Lawrence Ave East (Scarborough General Hospita': 'McCowan Rd at Lawrence Ave East (Scarborough General Hospital)',
    'Eglinton Ave West at Everden Rd (Eglinton West Sta': 'Eglinton Ave West at Everden Rd (Eglinton West Station)',
  },
};
